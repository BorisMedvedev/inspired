export const renderProducts = () => {
	...
	<ul class="goods__list list-reset">
		<li class="goods__item">
			<article class="product-card">
				<a class="product-card__link" href="#">
					<img class="product-card__img" src="./img/foto-card-1.jpg"
				...
				<div class="product-card__row">
					<p class="product-card__price">руб 1799</p>
					<button class="product-card__btn-favorite product-card__btn-favorite--active btn-reset"
		...
		<li class="goods__item">
			<article class="product-card">
				<a class="product-card__link" href="#">
					<img class="product-card__img" src="./img/foto-card-2.jpg"
						alt="Бюстгальтер-Балконет Bien из Микрофибры">
					<h3 class="product-card__title">
						Бюстгальтер-Балконет Bien из Микрофибры
					</h3>
