...
export const searchButton = createElement("button", {
	className: "header__nav-link btn-reset link-hover",
	innerHTML: `
...
export const container = createElement("div", {
	...
	innerHTML: `
			<a class="header__phone link-hover" href="tel:89304902620">8 930 490 26 20</a>

			<a href="#" class="logo">
				<img class="logo__img" src="${logo}" alt="логотип Inspired">
			</a>
	`,
});
...
createElement(
	"ul",
	{
		className: "header__nav-list list-reset",
	},
	{
		parent: nav,
		appends: [
