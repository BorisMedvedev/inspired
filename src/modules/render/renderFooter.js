				...
				<div class="footer__container">
					<div class="footer__wrapper">
						<div class="footer__item footer__item-category footer-category">
							<h2 class="footer-title footer-category__title">Каталог</h2>

							<ul class="footer-category__list list-reset">
								<li class="footer-category__item">
									<h3 class="footer-category__subtitle">Женщины</h3>
									<ul class="footer-category__sublist list-reset">
										<li class="footer-category__subtem">
											<a href="#" class="footer__link link-hover">Бюстгальтеры</a>
										</li>
										<li class="footer-category__subtem">
											<a href="#" class="footer__link link-hover">Трусы</a>
										</li>
										<li class="footer-category__subtem">
											<a href="#" class="footer__link link-hover">Носки</a>
										</li>
										<li class="footer-category__subtem">
											<a href="#" class="footer__link link-hover">Халаты</a>
										</li>
										<li class="footer-category__subtem">
											<a href="#" class="footer__link link-hover">Термобелье</a>
										</li>
										<li class="footer-category__subtem">
											<a href="#" class="footer__link link-hover">Пижамы</a>
										</li>
									</ul>
								</li>
								<li class="footer-category__item">
						...
						<div class="footer__item footer__item-social footer-social">
							<h2 class="footer-title footer-social__title">
								Связаться с нами
							</h2>
							<h3 class="footer-social__subtitle">
								Контакты и адреса магазинов
							</h3>
							<ul class="footer-social__list list-reset">
								<li class="footer-social__item">
									<a class="footer-social__link link-hover" href="#" aria-label="социальная сеть в контакте">
								...
								<li class="footer-social__item">
									<a class="footer-social__link link-hover" href="#" aria-label="это запрещенная социальная сеть">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
											xmlns="http://www.w3.org/2000/svg">
											<path
						...
						<div class="footer__item footer__item-contacts footer-contacts">
							<a class="footer-contacts__mail link-hover" href="mailto:Inspired@gmail.com">Inspired@gmail.com</a>
							<a class="footer-contacts__phone link-hover" href="tel:89304902620">8 930 490 26 20</a>
						</div>
					</div>

					<div class="footer__inner">
						<div class="footer__item footer__item-copyright footer-copyright">
							<p class="footer-copyright__text">© INSPIRED, 2023</p>
						</div>

						<div class="footer__item footer__item-development footer-development">
							<ul class="footer-development__list list-reset">
								<li class="footer-development__item">
									Designer: <a class="link-hover" href="#">Anastasia Ilina</a>
								</li>
								<li class="footer-development__item">
									Developer: : <a class="link-hover" href="#">Boris Medvedev</a>
								</li>
							</ul>
						</div>
					</div>
